...
public abstract class StorageAbstract<T extends Comparable<T>> implements StorageInterface<T> {
    ...
    /**
     * This method checks if the parameter type is Integer or String
     * and check if element is even length in case of String and check if
     * element is odd in case of Integer.
     * @param o Integer or String element
     * @throws NonEvenException
     */
    public boolean isEvenIntOrStringLength(T o) throws NonEvenException {
        if(o instanceof Integer) {
            if(((Integer)o % 2) != 0 ) {
                throw new NonEvenException("Should be Even Integer!!!");
            }
            return false;
        }
        if(o instanceof String) {
            if((((String) o).length() % 2 != 0)) {
                throw new NonEvenException("Should be Even length String!!!");
            }
            return false;
        }
        return  false;
